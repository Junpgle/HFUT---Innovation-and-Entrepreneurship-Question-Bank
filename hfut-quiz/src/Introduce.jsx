...
const LandingPage = () => {
    ...
    useEffect(() => {
        try {
            const raw = localStorage.getItem('AV/5wPsbnakcoOjfaPzfC44vfW5-gzGzoHsz/currentUser');
            if (raw) {
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-8 animate-in slide-in-from-bottom-10 duration-700">
                        ...
                        <p className="text-lg md:text-xl text-slate-500 leading-relaxed max-w-lg">
                            专为工大学子打造的智能刷题系统。通过大数据分析与自动错题收录，让你的复习效率提升 300%。
                        </p>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <FeatureCard
                            ...
                            color="amber"
                            title="极速刷题体验"
                            desc="专为碎片化时间打造。0 秒启动，无广告干扰，极简交互设计。无论是在食堂排队还是课间休息，随时拿出手机刷几道。利用好每一分钟，积少成多，轻松通关。"
                        />
                        <FeatureCard
                            icon={ShieldCheck}
                            color="blue"
                            title="云端实时同步"
                            desc="采用企业级云同步技术，确保学习进度在电脑、平板和手机间无缝流转。在宿舍用电脑刷题，出门用手机复习，数据永不丢失，体验如影随形。"
                        />
                        <FeatureCard
                            icon={Users}
                            color="violet"
