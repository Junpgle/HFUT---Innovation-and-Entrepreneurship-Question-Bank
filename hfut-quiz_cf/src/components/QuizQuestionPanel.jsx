  ...
  return (
    <div className="md:col-span-2 bg-white rounded-[1.5rem] md:rounded-[2rem] p-5 md:p-8 shadow-sm border border-slate-200 animate-enter h-full flex flex-col">
      <div className="flex items-center gap-3 mb-4 md:mb-6">
        ...
        <span className="text-slate-400 text-xs md:text-sm font-medium flex items-center gap-1">{currentQ.category}</span>
      </div>
      <h2 className="text-lg md:text-2xl font-bold text-slate-900 leading-relaxed mb-4">{currentQ.question}</h2>
