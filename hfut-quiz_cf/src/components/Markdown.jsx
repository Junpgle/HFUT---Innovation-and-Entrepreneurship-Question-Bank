...
export function Markdown({ content, size = 'sm', className = '' }) {
  const components = {
    ...
    blockquote: ({ ...props }) => <blockquote className="border-l-4 border-blue-400 bg-blue-50/50 text-slate-600 italic px-4 py-3 rounded-r-lg my-4" {...props} />,
