              ...
              {!showExplanationForm ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button onClick={() => { setShowExplanationForm(false); setNewExplanation(''); }} className="px-4 py-2 bg-slate-200 hover:bg-slate-300 text-slate-700 rounded-lg text-sm font-medium">
                      取消
                    </button>
                  </div>
                </div>
                    ...
                    {isEditing ? (
                      ...
                      <>
                        ...
                        <div className="flex items-center gap-3 text-xs">
                          {isOwner ? (
                            <>
                              <div className={`flex items-center gap-1 cursor-default ${comment.likes > 0 ? 'text-amber-600 font-bold' : 'text-slate-400'}`} title="收获的点赞数">
                            ...
                            <button
                              ...
                              className={`flex items-center gap-1 transition-colors ${comment.liked ? 'text-amber-600 font-bold' : 'text-slate-400 hover:text-amber-600'}`}
                            >
